    ...
    function(t, e, n) {
      ...
      (B.prototype._executor = null),
        ...
        (B.prototype.listRemote = function(t, e) {
          return this._runTask(
            P(B.getTrailingOptions(arguments)),
            B.trailingFunctionArgument(arguments)
          );
        }),
        ...
        (B.prototype.merge = function(t, e) {
          ...
          if (("merge" !== r[0] && r.unshift("merge"), 1 === r.length))
            return this._runTask(
              o("Git.merge requires at least one option"),
              n
            );
          ...
          return (this._chain = this._chain.then(() =>
            r(this, void 0, void 0, function*() {
              try {
                ...
                if (
                  ((this._chain = Promise.resolve()), e instanceof o.GitError)
                )
                  throw ((e.task = t), e);
          ...
          return r(this, void 0, void 0, function*() {
            ...
            return new Promise(o => {
              ...
              l.stdout.on("data", t => s.push(t)),
                ...
                l.on("error", t =>
                  u.push(Buffer.from(String(t.stack), "ascii"))
                ),
                l.on("close", t => c(t)),
                l.on("exit", c),
